...
class Interface{
    ...
    private static void manuel(){
        ...
        System.out.println("    ajtcalc file [filename] <expressionw>      to interpret a file where there is a list of expressions");
        System.out.println("    ajtcalc help                               to print a user manual");
        System.out.println("");
        System.out.println("");
        ...
        System.out.println("        Numbers are typed in the decimal system. You can use decimal numbers.");
        System.out.println("");
        ...
        System.out.println("        You can apply functions on numbers or expressions.");
        ...
        System.out.println("");
        System.out.println("    #!");
        System.out.println("        You can make an ajtcalc file executable. With this repository's makefile the interpreter you will have ta call /usr/local/share/ajtcalc/ajtcalc-shebang.");
        System.out.println("");
        ...
        System.out.println("* exit() : exit a shell or stop an interpreter");
        System.out.println("* ans(n) : in a shell or an interpreter, return the nth previous answer (starting at 0), if no argument is given the previous answer will be chosen");
